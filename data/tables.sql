/* We start a transaction in order to ensure the overall consistency of the database */
BEGIN;

/* First we delete the tables if they exist */
...
--
-- Contents oh the pokemon table
--

INSERT INTO "pokemon" ("id", "name", "pv", "attack", "defense", "attack_spe", "defense_spe", "speed", "number") VALUES
...
(1305, 'Hypnameade', 85, 73, 70, 73, 115, 67, 97),
...
/* We don't forget the junction table! */
-- ------------------------------------------
-- --------- Pokemon_type table -------------
-- ------------------------------------------
...
--
-- Contents of the pokemon_type table
--
